...
class CalculadoraConHistorial(Calculo):
    ...
    def realizar_operacion(self, operacion, num1, num2):
        ...
        if operacion == 'suma':
            resultado = ##usa el metodo suma() de la clase padre

        elif operacion == 'resta':
            resultado = ##usa el metodo resta() de la clase padre##

        elif operacion == 'multiplicacion':
            resultado = ##usa el metodo multiplicacion() de la clase padre##

        elif operacion == 'division':   
            resultado = ##usa el metodo division() de la clase
